...
B 2 1310 60 2110 460 {flags=graph
y1=0
y2=3.5
ypos1=0
ypos2=2
...
"PWL(0n 1.2 1u 1.2 1.01u 1.1 2u 1.1 2.01u 1.0 3u 1.0 3.01u 0.95 4u 0.95 4.01u 0.9 5u 1.1 5.01u 1.1"
savecurrent=false}
C {lab_pin.sym} 40 -450 0 1 {name=p2 sig_type=std_logic lab=IN_P}
C {gnd.sym} 40 -390 0 0 {name=l3 lab=GND}
C {vsource.sym} 40 -530 0 0 {name=V1 value=1 savecurrent=false}
...
C {vsource.sym} -340 -420 0 0 {name=V14 value=
