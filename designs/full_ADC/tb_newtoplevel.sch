...
C {vsource.sym} 960 -210 0 0 {name=V6 value=PULSE"(0 3.3 0 100p 100p 0.2u 1.2u)" savecurrent=false}
C {lab_pin.sym} 1070 -240 0 1 {name=p41 sig_type=std_logic lab=RESET}
C {gnd.sym} 960 -180 0 0 {name=l12 lab=GND}
C {res.sym} 1040 -240 1 0 {name=R5
value=50
footprint=1206
device=resistor
m=1}
