...
S {}
E {}
B 2 1150 -960 1950 -560 {flags=graph
ypos1=-0.20601983
ypos2=1.793979
subdivy=1
unity=1
...
C {libs/SAR_logic/SARlogicV3.sym} 330 -40 0 0 {name=x1}
C {comparator/inv.sym} 380 -1100 0 0 {name=xinv1}
C {lab_pin.sym} 460 -1100 3 1 {name=p7 sig_type=std_logic lab=VDD_3V3}
C {gnd.sym} 460 -940 0 0 {name=l3 lab=GND}
C {lab_pin.sym} 380 -1020 0 0 {name=p12 sig_type=std_logic lab=RESET}
C {lab_pin.sym} 530 -1020 0 1 {name=p13 sig_type=std_logic lab=RESETB}
C {lab_pin.sym} 540 -220 0 0 {name=p14 sig_type=std_logic lab=RESETB}
C {comparator/inv.sym} 810 -1100 0 0 {name=xinv2}
C {lab_pin.sym} 890 -1100 3 1 {name=p11 sig_type=std_logic lab=VDD_3V3}
C {gnd.sym} 890 -940 0 0 {name=l6 lab=GND}
C {lab_pin.sym} 810 -1020 0 0 {name=p15 sig_type=std_logic lab=COMP_IN}
C {lab_pin.sym} 960 -1020 0 1 {name=p16 sig_type=std_logic lab=COMP_INB}
