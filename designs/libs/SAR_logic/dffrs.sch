...
N 545 -460 665 -460 {lab=#net1}
N 385 -700 385 -460 {lab=clk}
N 405 -480 425 -480 {lab=#net2}
N 405 -540 405 -480 {lab=#net2}
N 405 -560 585 -640 {lab=#net2}
N 405 -560 405 -540 {lab=#net2}
N 585 -720 585 -640 {lab=#net2}
N 405 -790 585 -870 {lab=#net3}
N 405 -790 405 -740 {lab=#net3}
N 585 -920 585 -870 {lab=#net3}
N 585 -790 585 -720 {lab=#net2}
N 405 -850 585 -790 {lab=#net2}
N 405 -900 405 -850 {lab=#net2}
N 405 -900 425 -900 {lab=#net2}
N 385 -700 425 -700 {lab=clk}
N 385 -460 425 -460 {lab=clk}
N 285 -940 425 -940 {lab=#net4}
N 285 -940 285 -440 {lab=#net4}
N 285 -440 425 -440 {lab=#net4}
N 405 -440 405 -390 {lab=#net4}
N 405 -390 565 -310 {lab=#net4}
N 565 -310 565 -270 {lab=#net4}
N 405 -290 415 -290 {lab=#net1}
N 405 -350 405 -290 {lab=#net1}
N 405 -350 565 -420 {lab=#net1}
N 565 -460 565 -420 {lab=#net1}
N 405 -740 425 -740 {lab=#net3}
N 785 -700 855 -700 {lab=Q}
N 785 -480 855 -480 {lab=Qb}
N 545 -920 585 -920 {lab=#net3}
N 535 -270 565 -270 {lab=#net4}
N 545 -720 585 -720 {lab=#net2}
N 585 -700 665 -700 {lab=#net2}
N 640 -720 665 -720 {lab=setb}
N 640 -1020 640 -720 {lab=setb}
N 380 -1020 640 -1020 {lab=setb}
N 380 -1020 380 -920 {lab=setb}
N 380 -920 425 -920 {lab=setb}
N 265 -920 380 -920 {lab=setb}
N 260 -720 425 -720 {lab=resetb}
N 260 -720 260 -180 {lab=resetb}
N 245 -180 260 -180 {lab=resetb}
N 260 -270 415 -270 {lab=resetb}
N 640 -480 665 -480 {lab=resetb}
N 640 -480 640 -180 {lab=resetb}
...
C {libs/SIPO/nand3.sym} 285 -290 0 0 {name=x2}
...
C {libs/SIPO/nand3.sym} 285 -550 0 0 {name=x1}
C {libs/SIPO/nand3.sym} 525 -530 0 0 {name=x3}
C {libs/SIPO/nand3.sym} 525 -310 0 0 {name=x4}
C {libs/SIPO/nand3.sym} 285 -750 0 0 {name=x5}
C {libs/SIPO/nand3.sym} 275 -100 0 0 {name=x6}
C {iopin.sym} 245 -180 2 0 {name=p7 lab=resetb}
C {iopin.sym} 265 -920 2 0 {name=p8 lab=setb}
