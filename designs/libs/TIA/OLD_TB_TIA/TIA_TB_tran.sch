...
S {}
E {}
B 2 4060 -1190 4860 -790 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
logx=0
logy=0
rawfile=$netlist_dir/TIA_TB_tran.raw
autoload=1
sim_type=tran
color=4
node=i_in
...
y1=-100e-6
y2=400e-6}
B 2 4060 -770 4860 -370 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
N 1590 -1200 2180 -1200 {lab=i_ref}
N 1550 -1300 1550 -1230 {lab=vdd}
N 1550 -1300 2220 -1300 {lab=vdd}
...
N 1620 -1200 1620 -1130 {lab=i_ref}
N 3380 -750 3460 -750 {lab=out}
N 2190 -1620 2190 -1580 {lab=GND}
N 2190 -1720 2190 -1680 {lab=vss}
...
N 1530 -1200 1550 -1200 {lab=vdd}
N 1530 -1240 1530 -1200 {lab=vdd}
N 1530 -1240 1550 -1240 {lab=vdd}
...
N 2010 -1610 2010 -1570 {lab=vss}
N 1550 -1170 1550 -1120 {lab=i_ref}
N 2220 -1170 2220 -1140 {lab=#net1}
N 2940 -1170 2940 -1120 {lab=cd}
N 2960 -1200 2970 -1200 {lab=vdd}
N 3380 -1300 3380 -1190 {lab=vdd}
N 1550 -1120 1550 -1060 {lab=i_ref}
N 1550 -1130 1620 -1130 {lab=i_ref}
...
N 1430 -1740 1490 -1740 {lab=in_p}
N 1430 -1680 1490 -1680 {lab=vdd}
N 1430 -1650 1490 -1650 {lab=vss}
N 2270 -1620 2270 -1580 {lab=vss}
N 2270 -1720 2270 -1680 {lab=i_ref}
N 1430 -1620 1490 -1620 {lab=i_ref}
...
N 1860 -1770 1860 -1730 {lab=in_n}
N 1860 -1790 1860 -1770 {lab=in_n}
N 1860 -1670 1860 -1650 {lab=vss}
N 1860 -1590 1860 -1540 {lab=vss}
N 1860 -1650 1860 -1590 {lab=vss}
N 3040 -350 3040 -310 {lab=vdd}
N 2780 -820 2780 -780 {lab=vdd}
N 2100 -1810 2100 -1770 {lab=vdd}
N 2100 -1710 2100 -1680 {lab=#net4}
N 2010 -1800 2010 -1760 {lab=in_p}
N 2010 -1700 2010 -1670 {lab=#net5}
N 1860 -1770 1920 -1770 {lab=in_n}
N 1920 -1670 1920 -1620 {lab=vss}
N 1860 -1620 1920 -1620 {lab=vss}
N 1920 -1770 1920 -1730 {lab=in_n}
N 2270 -1780 2270 -1720 {lab=i_ref}
N 2340 -1660 2340 -1610 {lab=vss}
N 2340 -1760 2340 -1720 {lab=i_ref}
N 2270 -1760 2340 -1760 {lab=i_ref}
N 2270 -1610 2340 -1610 {lab=vss}
N 1860 -1830 1860 -1790 {lab=in_n}
N 2010 -1570 2010 -1550 {lab=vss}
N 2010 -1550 2010 -1540 {lab=vss}
N 2100 -1620 2100 -1550 {lab=vss}
N 2010 -1830 2010 -1800 {lab=in_p}
N 2100 -1820 2100 -1810 {lab=vdd}
N 2100 -1830 2100 -1820 {lab=vdd}
N 2100 -1550 2100 -1540 {lab=vss}
...
C {lab_pin.sym} 2100 -1830 3 1 {name=p12 sig_type=std_logic lab=vdd}
...
descr="id="}
C {devices/ngspice_get_expr.sym} 1390 -1260 0 0 {name=r148 
node="[format %.4g [expr [ngspice::get_node \{@m.xmp_mirror.m0[gm]\}] / [ngspice::get_node \{i(@m.xmp_mirror.m0[id])\}]]]"
descr="gm/ID="}
C {devices/ngspice_get_value.sym} 1390 -1230 0 0 {name=r149 node=v(@m.xmp_mirror.m0[vdsat])
descr="vdsat="}
C {devices/ngspice_get_value.sym} 1390 -1200 0 0 {name=r150 node=v(@m.xmp_mirror.m0[vds])
descr="vds="}
C {devices/ngspice_get_value.sym} 1450 -1260 0 0 {name=r151 node=i(@m.xmp_mirror.m0[id])
descr="id="}
C {devices/ngspice_get_value.sym} 1450 -1230 0 0 {name=r152 node=@m.xmp_mirror.m0[gm]
descr="gm="}
...
.endc
"}
C {lab_pin.sym} 2190 -1720 3 1 {name=p40 sig_type=std_logic lab=vss}
C {lab_wire.sym} 2010 -1540 1 0 {name=p41 sig_type=std_logic lab=vss
}
C {vsource.sym} 2010 -1640 0 0 {name=V6 value="1.2" savecurrent=false}
...
C {ipin.sym} 1430 -1740 0 0 {name=p44 lab=in_p}
C {lab_pin.sym} 1490 -1740 0 1 {name=p45 sig_type=std_logic lab=in_p
}
C {ipin.sym} 1430 -1680 0 0 {name=p46 lab=vdd}
C {lab_pin.sym} 1490 -1680 0 1 {name=p47 sig_type=std_logic lab=vdd
}
C {ipin.sym} 1430 -1650 0 0 {name=p48 lab=vss}
C {lab_pin.sym} 1490 -1650 0 1 {name=p49 sig_type=std_logic lab=vss
}
C {isource.sym} 2270 -1650 0 0 {name=I3 value=20u}
C {lab_pin.sym} 2270 -1780 3 1 {name=p50 sig_type=std_logic lab=i_ref}
C {ipin.sym} 1430 -1620 0 0 {name=p51 lab=i_ref}
C {lab_pin.sym} 1490 -1620 0 1 {name=p52 sig_type=std_logic lab=i_ref
}
C {lab_pin.sym} 1550 -1060 1 1 {name=p53 sig_type=std_logic lab=i_ref
}
...
C {lab_pin.sym} 2010 -1830 3 1 {name=p2 sig_type=std_logic lab=in_p}
C {lab_wire.sym} 1860 -1540 1 0 {name=p3 sig_type=std_logic lab=vss
}
C {lab_pin.sym} 1860 -1830 3 1 {name=p4 sig_type=std_logic lab=in_n}
C {isource.sym} 1860 -1700 2 0 {name=I_IN value="SIN(75e-6 74.99e-6  100e3 1e-9)"}
...
spiceprefix=X
m=15}
C {res.sym} 1920 -1700 0 0 {name=R3
value=1G
footprint=1206
device=resistor
m=1}
C {res.sym} 2100 -1740 0 0 {name=R4
value=10
footprint=1206
device=resistor
m=1}
C {res.sym} 2010 -1730 0 0 {name=R5
value=10
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 2270 -1580 1 1 {name=p7 sig_type=std_logic lab=vss}
C {res.sym} 2340 -1690 0 0 {name=R6
value=1G
footprint=1206
device=resistor
m=1}
C {lab_wire.sym} 2100 -1540 1 0 {name=p8 sig_type=std_logic lab=vss
}
