...
S {}
E {}
B 2 4090 -1510 4890 -1110 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
logx=0
logy=0
rawfile=$netlist_dir/TIA_TB_linearity.raw
autoload=1
y2=1.2
x1=-1.6940659e-21
x2=0.0003
...
N 2100 -1580 2100 -1540 {lab=GND}
N 2010 -1580 2010 -1540 {lab=vss}
N 2100 -1680 2100 -1640 {lab=vss}
N 1930 -1580 1930 -1540 {lab=vss}
N 2180 -1580 2180 -1540 {lab=vss}
N 2180 -1680 2180 -1640 {lab=i_ref}
N 2010 -1770 2010 -1730 {lab=vdd}
N 2010 -1670 2010 -1640 {lab=#net4}
N 1930 -1770 1930 -1730 {lab=in_p}
N 1930 -1670 1930 -1640 {lab=#net5}
N 2180 -1740 2180 -1680 {lab=i_ref}
N 2250 -1620 2250 -1570 {lab=vss}
N 2250 -1720 2250 -1680 {lab=i_ref}
N 2180 -1720 2250 -1720 {lab=i_ref}
N 2180 -1570 2250 -1570 {lab=vss}
N 1810 -1630 1810 -1580 {lab=vss}
N 1810 -1730 1810 -1690 {lab=in_n}
N 1810 -1750 1810 -1730 {lab=in_n}
N 1750 -1750 1810 -1750 {lab=in_n}
N 1750 -1580 1810 -1580 {lab=vss}
...
spiceprefix=X
m=15}
C {vsource.sym} 2010 -1610 0 0 {name=V1 value=3.3 savecurrent=false}
C {vsource.sym} 2100 -1610 0 0 {name=V2 value=0 savecurrent=false}
C {gnd.sym} 2100 -1540 0 0 {name=l1 lab=GND}
C {lab_pin.sym} 2010 -1770 3 1 {name=p7 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 2010 -1540 1 1 {name=p8 sig_type=std_logic lab=vss}
C {lab_pin.sym} 2100 -1680 3 1 {name=p9 sig_type=std_logic lab=vss}
C {lab_wire.sym} 1930 -1540 1 0 {name=p10 sig_type=std_logic lab=vss
}
C {vsource.sym} 1930 -1610 0 0 {name=V5 value="1.2" savecurrent=false}
C {isource.sym} 2180 -1610 0 0 {name=I1 value=20u}
C {lab_pin.sym} 2180 -1740 3 1 {name=p11 sig_type=std_logic lab=i_ref}
C {lab_pin.sym} 1930 -1770 3 1 {name=p13 sig_type=std_logic lab=in_p}
C {res.sym} 2010 -1700 0 0 {name=R4
value=10
footprint=1206
device=resistor
m=1}
C {res.sym} 1930 -1700 0 0 {name=R5
value=10
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 2180 -1540 1 1 {name=p16 sig_type=std_logic lab=vss}
C {res.sym} 2250 -1650 0 0 {name=R6
value=1G
footprint=1206
device=resistor
m=1}
C {res.sym} 1810 -1660 0 0 {name=R7
value=1G
footprint=1206
device=resistor
m=1}
