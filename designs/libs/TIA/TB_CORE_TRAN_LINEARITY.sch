...
S {}
E {}
B 2 550 -570 1350 -170 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
logx=0
logy=0
rawfile=$netlist_dir/TB_CORE_LINEARITY.raw
autoload=1
y2=1.2
y1=0.8
sim_type=dc
...
x2=300e-6
x1=0}
B 2 550 -140 1350 260 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
logx=0
logy=0
rawfile=$netlist_dir/TB_CORE_TRAN.raw
autoload=1
sim_type=tran
color=4
node=i_in
...
y1=-100e-6
y2=200e-6}
B 2 550 280 1350 680 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
spiceprefix=X
m=1}
C {devices/code_shown.sym} -1230 120 0 0 {name=MODELS1 only_toplevel=true
...
"}
C {devices/code_shown.sym} -1210 -970 0 0 {name=NGSPICE1 only_toplevel=true
value="
...
C {launcher.sym} -630 -180 0 0 {name=h1
descr="LOAD_WAVE" 
tclcommand="xschem raw_read $netlist_dir/TB_CORE_TRAN.raw tran"
}
