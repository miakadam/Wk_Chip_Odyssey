...
N -380 -20 -380 10 {lab=Vref}
N -380 -20 -160 -20 {lab=Vref}
...
C {vsource.sym} 160 380 0 1 {name=Vbit2 value=3.3 savecurrent=false}
C {vsource.sym} 50 400 0 1 {name=Vbit3 value=3.3 savecurrent=false}
C {vsource.sym} -50 400 0 1 {name=Vbit4 value=3.3 savecurrent=false}
C {vsource.sym} -140 370 0 1 {name=Vbit5 value=3.3 savecurrent=false}
C {vsource.sym} -240 330 0 1 {name=Vbit6 value=3.3 savecurrent=false}
C {vsource.sym} -380 40 0 0 {name=Vref value=1.2 savecurrent=false}
...
C {lab_wire.sym} -190 30 0 0 {name=p9 sig_type=std_logic lab=avss}
...
"}
C {lab_wire.sym} 180 -20 0 0 {name=p10 sig_type=std_logic lab=Vdac}
C {lab_wire.sym} -270 -20 0 0 {name=p13 sig_type=std_logic lab=Vref}
