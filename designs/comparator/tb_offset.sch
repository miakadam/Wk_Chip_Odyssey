...
tclcommand="
xschem raw_read $netlist_dir/tb_offset.raw tran; xschem redraw
"
}
...
.measure tran t_VxVy_200mV FIND time WHEN V(vdiff)=0.2 CROSS=1
.measure tran t_VxVy_n200mV FIND time WHEN V(vdiff)=-0.2 CROSS=1
.measure tran comp_speed PARAM='t_VxVy_200mV - t_clk_vdd2'
.measure tran comp_nspeed PARAM='1 / ((t_VxVy_n200mV - t_clk_vdd2) * 2)'
.save comp_speed
.save comp_nspeed
"}
...
C {strongArmLatch_offsetM3.sym} 310 -190 0 0 {name=x1}
