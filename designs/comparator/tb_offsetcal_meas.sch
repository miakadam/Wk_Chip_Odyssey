...
C {capa.sym} 1710 -280 0 0 {name=C1
m=1
value=15p
footprint=1206
...
C {gnd.sym} 1710 -250 0 0 {name=l8 lab=GND}
...
C {launcher.sym} 500 -665 0 0 {name=h5 
descr="load ngspice waves" 
tclcommand="
xschem raw_read $netlist_dir/tb_offsetcal_meas.raw tran; xschem redraw
"
}
...
C {lab_pin.sym} 440 -260 0 0 {name=p38 sig_type=std_logic lab=IN_N}
