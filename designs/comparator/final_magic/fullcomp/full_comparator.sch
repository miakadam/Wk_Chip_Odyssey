...
C {comparator/final_magic/lvsclean_SAlatch/lvsclean_SAlatch.sym} 60 -50 0 0 {name=x1}
...
C {comparator/final_magic/osu_sc/inverter/mia/inv_mia.sym} 720 -470 0 0 {name=x3}
C {comparator/final_magic/osu_sc/inverter/mia/inv_mia.sym} 730 200 0 0 {name=x5}
