...
N 190 -30 210 -30 { lab=VSS}
N 410 -390 410 -360 { lab=VDD}
N 360 -330 370 -330 { lab=C}
N 410 -330 430 -330 { lab=VDD}
N 410 -300 410 -270 {lab=Y}
N 420 -270 460 -270 {lab=Y}
N 320 -270 420 -270 {lab=Y}
C {vdd.sym} 120 -390 0 0 {name=l1 lab=VDD}
C {vdd.sym} 260 -390 0 0 {name=l2 lab=VDD}
C {gnd.sym} 190 30 0 0 {name=l3 lab=VSS}
...
C {opin.sym} 460 -270 0 0 {name=p3 lab=Y}
C {ipin.sym} -30 -60 0 0 {name=p4 lab=VDD}
C {ipin.sym} -30 -30 0 0 {name=p5 lab=VSS}
C {symbols/nfet_03v3.sym} 170 -30 0 0 {name=M5 L=0.3u W=0.85u m=1 nf=1 ad="'int((nf+1)/2) * W/nf * 0.18u'" pd="'2*int((nf+1)/2) * (W/nf + 0.18u)'" as="'int((nf+2)/2) * W/nf * 0.18u'" ps="'2*int((nf+2)/2) * (W/nf + 0.18u)'" nrd="'0.18u / W'" nrs="'0.18u / W'" sa=0 sb=0 sd=0 model=nfet_03v3 spiceprefix=X}
C {lab_wire.sym} 130 -30 0 0 {name=l10 sig_type=std_logic lab=C}
C {lab_wire.sym} 210 -30 2 0 {name=l11 sig_type=std_logic lab=VSS}
C {vdd.sym} 410 -390 0 0 {name=l12 lab=VDD}
C {symbols/pfet_03v3.sym} 390 -330 0 0 {name=M6 L=0.3u W=1.7u m=1 nf=1 ad="'int((nf+1)/2) * W/nf * 0.18u'" pd="'2*int((nf+1)/2) * (W/nf + 0.18u)'" as="'int((nf+2)/2) * W/nf * 0.18u'" ps="'2*int((nf+2)/2) * (W/nf + 0.18u)'" nrd="'0.18u / W'" nrs="'0.18u / W'" sa=0 sb=0 sd=0 model=pfet_03v3 spiceprefix=X}
C {lab_wire.sym} 430 -330 2 0 {name=l13 sig_type=std_logic lab=VDD}
C {ipin.sym} 360 -330 0 0 {name=p6 lab=C}
