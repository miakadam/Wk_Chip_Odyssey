...
N 280 -310 330 -310 {lab=IN_N}
N 280 -250 330 -250 {lab=IN_N}
N 270 -310 280 -310 {lab=IN_N}
...
.control
tran 100p 20u
write tb_inputnoise.raw
.endc"}
C {strongArmLatch.sym} 490 -290 0 0 {name=x1}
C {vsource.sym} 160 -390 0 0 {name=V1 value=1.65 savecurrent=false}
...
tclcommand="
xschem raw_read $netlist_dir/tb_inputnoise.raw tran; xschem redraw
"
}
...
spice_ignore=true}
C {lab_pin.sym} 270 -310 0 0 {name=p1 sig_type=std_logic lab=IN_N}
C {lab_pin.sym} 270 -250 0 0 {name=p2 sig_type=std_logic lab=IN_N}
